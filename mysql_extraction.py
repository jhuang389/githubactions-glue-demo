...
if load_type=="incremental":
    s3_key = f'lab9-cicd/raw_landing_zone/apartment_db/{table_name}/{date_filter}/data.csv'
else:
    s3_key = f'lab9-cicd/raw_landing_zone/apartment_db/{table_name}/data.csv'
